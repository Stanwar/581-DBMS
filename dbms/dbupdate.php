...
elseif ($congestion == 80) {
$sql ="UPDATE db_projection SET db_projection.available_80=db_projection.available_80-1 WHERE db_projection.block_id='$q' and db_projection.timestamp ='$ts1'";
}
